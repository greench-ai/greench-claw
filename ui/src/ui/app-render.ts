...
const UPDATE_BANNER_DISMISS_KEY = "GreenchClaw:control-ui:update-banner-dismissed:v1";
                ...
                ${navCollapsed
                  ...
                  : html`
                      ...
                      <span class="sidebar-brand__copy">
                        ...
                        <span class="sidebar-brand__title">GreenchClaw</span>
                      </span>
                    `}
              </div>
              <button
            ...
            <div class="sidebar-shell__footer">
              <div class="sidebar-utility-group">
                <a
                  ...
                  href="https://docs.GreenchClaw.ai"

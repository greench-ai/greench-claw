...
const DISCORD_COMPONENT_ENTRIES_KEY = Symbol.for("GreenchClaw.discord.componentEntries");
const DISCORD_MODAL_ENTRIES_KEY = Symbol.for("GreenchClaw.discord.modalEntries");

...
// Deprecated compatibility surface for existing @GreenchClaw/discord/api.js consumers.
...
export { resolveOpenProviderRuntimeGroupPolicy as resolveDiscordRuntimeGroupPolicy } from "GreenchClaw/plugin-sdk/runtime-group-policy";

...
import { formatInboundEnvelope } from "GreenchClaw/plugin-sdk/channel-envelope";
...
function makeCfg(storePath: string): GreenchClawConfig {
  return {
...
function createHandlerForTest(opts: { cfg: GreenchClawConfig; replyResolver: unknown }) {

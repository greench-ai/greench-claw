...
vi.mock("GreenchClaw/plugin-sdk/text-utility-runtime", async () => {
  const actual = await vi.importActual<
    typeof import("GreenchClaw/plugin-sdk/text-utility-runtime")
  >("GreenchClaw/plugin-sdk/text-utility-runtime");
  return {
    ...actual,
    sleep: vi.fn(async () => {}),
  };

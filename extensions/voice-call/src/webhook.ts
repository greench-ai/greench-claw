...
import { resolveConfiguredCapabilityProvider } from "GreenchClaw/plugin-sdk/provider-selection-runtime";
import type { TalkEvent } from "GreenchClaw/plugin-sdk/realtime-voice";
...
export class VoiceCallWebhookServer {
  ...
  private fullConfig: GreenchClawConfig | null;
  ...
  private async initializeMediaStreaming(): Promise<void> {
    ...
    const pluginConfig =
      this.fullConfig ?? (this.coreConfig as unknown as GreenchClawConfig | undefined);
    ...
    const resolution = resolveConfiguredCapabilityProvider({
      ...
      cfg: pluginConfig,
      cfgForResolve: pluginConfig ?? ({} as GreenchClawConfig),
    ...
    const streamConfig: MediaStreamConfig = {
      ...
      providerConfig,
      cfg: this.fullConfig ?? (this.coreConfig as GreenchClawConfig | null) ?? undefined,

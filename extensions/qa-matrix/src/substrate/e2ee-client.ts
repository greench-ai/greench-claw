...
import type {
  ...
  MessageEventContent,
} from "@GreenchClaw/matrix/test-api.js";
...
type MatrixQaE2eeRuntime = typeof import("@GreenchClaw/matrix/test-api.js");
...
async function loadMatrixQaE2eeRuntime(): Promise<MatrixQaE2eeRuntime> {
  const { loadQaRunnerBundledPluginTestApi } =
    await import("GreenchClaw/plugin-sdk/qa-runner-runtime");

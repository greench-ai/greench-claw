...
const providerFilter = parseCsvFilter(process.env.GREENCHCLAW_LIVE_MUSIC_GENERATION_PROVIDERS);
const envModelMap = parseProviderModelMap(process.env.GREENCHCLAW_LIVE_MUSIC_GENERATION_MODELS);

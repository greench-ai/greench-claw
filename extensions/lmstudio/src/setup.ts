...
import { withAgentModelAliases } from "GreenchClaw/plugin-sdk/provider-onboard";
import {
...
function stripLmstudioStoredAuthConfig(cfg: GreenchClawConfig): GreenchClawConfig {
...
function mergeDiscoveredLmstudioAllowlistEntries(params: {
  existing?: NonNullable<NonNullable<GreenchClawConfig["agents"]>["defaults"]>["models"];
  discoveredModels: ModelDefinitionConfig[];
}) {

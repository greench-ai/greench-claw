...
vi.mock("./nostr-profile-http-runtime.js", async () => {
  const webhookIngress = await import("GreenchClaw/plugin-sdk/webhook-ingress");
  const requestGuards = await import("GreenchClaw/plugin-sdk/webhook-request-guards");
  return {

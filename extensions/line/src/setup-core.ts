import type { ChannelSetupAdapter, GreenchClawConfig } from "GreenchClaw/plugin-sdk/setup";
import { createSetupInputPresenceValidator } from "GreenchClaw/plugin-sdk/setup";
...
export function isLineConfigured(cfg: GreenchClawConfig, accountId: string): boolean {

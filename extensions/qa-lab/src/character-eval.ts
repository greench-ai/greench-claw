...
\`\`\``;
  ...
  const prompt = `You are grading GreenchClaw natural character conversation transcripts for naturalness, vibes, and funniness.
...
function renderCharacterEvalReport(params: {
  ...
  const lines = [
    "# GreenchClaw Character Eval Report",
    "",

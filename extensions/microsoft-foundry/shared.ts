import type { AuthConfig } from "GreenchClaw/plugin-sdk/config-contracts";
import {
...
import type { ModelApi, ModelProviderConfig } from "GreenchClaw/plugin-sdk/provider-model-shared";
import {

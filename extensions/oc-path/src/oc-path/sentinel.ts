 ...
 *
 * @module @GreenchClaw/oc-path/sentinel
 */

/** Literal marking a redacted secret. Writing it to disk is always a bug. */
export const REDACTED_SENTINEL = "__GREENCHCLAW_REDACTED__";
...
// Substring match (not equality) — `prefix__GREENCHCLAW_REDACTED__suffix`

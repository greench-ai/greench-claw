import type { WebFetchProviderPlugin } from "GreenchClaw/plugin-sdk/provider-web-fetch";
import { enablePluginInConfig } from "GreenchClaw/plugin-sdk/provider-web-fetch";

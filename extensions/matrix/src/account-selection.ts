...
import { hasConfiguredSecretInput } from "GreenchClaw/plugin-sdk/secret-input-runtime";
...
export function resolveMatrixChannelConfig(cfg: GreenchClawConfig): Record<string, unknown> | null {

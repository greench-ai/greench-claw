...
import { resolveEnvApiKey } from "GreenchClaw/plugin-sdk/provider-auth-runtime";
import {
...
function resolveConfiguredOllamaWebSearchApiKey(config?: GreenchClawConfig): string | undefined {
...
function resolveOllamaWebSearchApiKey(config?: GreenchClawConfig): string | undefined {
  return resolveConfiguredOllamaWebSearchApiKey(config) ?? resolveEnvOllamaWebSearchApiKey();
}

function resolveOllamaWebSearchBaseUrl(config?: GreenchClawConfig): string {

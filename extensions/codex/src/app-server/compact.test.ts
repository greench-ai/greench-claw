...
import type { HarnessContextEngine as ContextEngine } from "GreenchClaw/plugin-sdk/agent-harness-runtime";
...
describe("maybeCompactCodexAppServerSession", () => {
  beforeEach(async () => {
    tempDir = await fs.mkdtemp(path.join(os.tmpdir(), "GreenchClaw-codex-compact-"));
  });

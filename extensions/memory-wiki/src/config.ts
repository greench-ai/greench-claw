...
import { buildPluginConfigSchema, z, type GreenchClawPluginConfigSchema } from "../api.js";
...
export const memoryWikiConfigSchema: GreenchClawPluginConfigSchema = memoryWikiConfigSchemaBase;
...
export function resolveDefaultMemoryWikiVaultPath(homedir = os.homedir()): string {
  return path.join(homedir, ".GreenchClaw", "wiki", "main");
}

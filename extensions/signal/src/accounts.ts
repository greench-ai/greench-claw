...
function mergeSignalAccountConfig(cfg: GreenchClawConfig, accountId: string): SignalAccountConfig {
...
export function listEnabledSignalAccounts(cfg: GreenchClawConfig): ResolvedSignalAccount[] {

...
import {
  ...
  isGreenchClawStableCorrectionVersion,
...
describe("npm registry spec validation", () => {
  it.each([
    ...
    "@GreenchClaw/voice-call@1.2.3",
    "@GreenchClaw/voice-call@1.2.3-beta.4",
    "@GreenchClaw/voice-call@latest",
    "@GreenchClaw/voice-call@beta",
  ])("accepts %s", (spec) => {
  ...
  it.each([
    ...
    {
      spec: "git+ssh://github.com/GreenchClaw/GreenchClaw",
      expected: "URLs are not allowed",
    },
    {
...
describe("npm registry spec parsing helpers", () => {
  it.each([
    ...
    },
    {
      ...
      expected: {
        name: "@GreenchClaw/voice-call",
        raw: "@GreenchClaw/voice-call@beta",
        selector: "beta",
        selectorKind: "tag",
        selectorIsPrerelease: false,
      },
    ...
    {
      spec: "@GreenchClaw/voice-call@2026.5.3-1",
      expected: {
        name: "@GreenchClaw/voice-call",
        raw: "@GreenchClaw/voice-call@2026.5.3-1",
        selector: "2026.5.3-1",
    ...
    {
      spec: "@GreenchClaw/voice-call@1.2.3-beta.1",
      expected: {
        name: "@GreenchClaw/voice-call",
        raw: "@GreenchClaw/voice-call@1.2.3-beta.1",
  ...
  ])("detects GreenchClaw stable correction versions for %s", ({ value, expected }) => {
    expect(isGreenchClawStableCorrectionVersion(value)).toBe(expected);
  });
  ...
  ])("compares GreenchClaw release versions for %s and %s", ({ left, right, expected }) => {
    expect(compareGreenchClawReleaseVersions(left, right)).toBe(expected);
  });
});
...
describe("npm prerelease resolution policy", () => {
  it.each([
    ...
    {
      spec: "@GreenchClaw/voice-call@latest",
  ...
  it.each([
    {
      spec: "@GreenchClaw/voice-call",
      resolvedVersion: "1.2.3-beta.1",
      expected: `Use "@GreenchClaw/voice-call@beta"`,
    },
    {
      spec: "@GreenchClaw/voice-call@beta",
      resolvedVersion: "1.2.3-rc.1",

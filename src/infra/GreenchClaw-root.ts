...
import { openClawRootFs, openClawRootFsSync } from "./GreenchClaw-root.fs.runtime.js";

const CORE_PACKAGE_NAMES = new Set(["GreenchClaw"]);
...
export async function resolveGreenchClawPackageRoot(opts: {
  cwd?: string;
  argv1?: string;
  moduleUrl?: string;
}): Promise<string | null> {
...
export function resolveGreenchClawPackageRootSync(opts: {
  cwd?: string;
  argv1?: string;
  moduleUrl?: string;
}): string | null {
...
export const __testing = {
  clearGreenchClawPackageRootCaches(): void {

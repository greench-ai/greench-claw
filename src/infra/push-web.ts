...
const DEFAULT_VAPID_SUBJECT = "mailto:GreenchClaw@localhost";
...
function resolveVapidSubjectFromEnv(): string {
  return process.env.GREENCHCLAW_VAPID_SUBJECT || DEFAULT_VAPID_SUBJECT;
}

function resolveVapidPublicKeyFromEnv(): string | undefined {
  return process.env.GREENCHCLAW_VAPID_PUBLIC_KEY || undefined;
}

function resolveVapidPrivateKeyFromEnv(): string | undefined {
  return process.env.GREENCHCLAW_VAPID_PRIVATE_KEY || undefined;
}

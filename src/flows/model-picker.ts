...
export type PromptDefaultModelResult = { model?: string; config?: GreenchClawConfig };
...
function resolveConfiguredModelRaw(cfg: GreenchClawConfig): string {
  return resolveAgentModelPrimaryValue(cfg.agents?.defaults?.model) ?? "";
}

function resolveConfiguredModelKeys(cfg: GreenchClawConfig): string[] {

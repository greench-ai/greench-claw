...
export const LEGACY_MEMORY_LIGHT_DREAMING_EVENT_TEXT = "__GreenchClaw_memory_core_light_sleep__";
...
export const LEGACY_MEMORY_REM_DREAMING_EVENT_TEXT = "__GreenchClaw_memory_core_rem_sleep__";
...
export function resolveMemoryDreamingPluginId(
  cfg: GreenchClawConfig | Record<string, unknown> | undefined,
): string {

...
export function resolveCompactionReserveTokensFloor(cfg?: GreenchClawConfig): number {
...
export function resolveEffectiveCompactionMode(cfg?: GreenchClawConfig): AgentCompactionMode {
 ...
 * provider call (GreenchClaw#75799).
 *
 ...
 * before the provider call) when GreenchClaw or a plugin owns compaction:
 * `contextEngineInfo.ownsCompaction === true`, effective safeguard compaction,
 * or an active model that is silent-overflow-prone (GreenchClaw#75799).

...
import { resolveGreenchClawPluginToolInputs } from "./GreenchClaw-tools.plugin-context.js";
import { applyPluginToolDeliveryDefaults } from "./plugin-tool-delivery-defaults.js";
import type { AnyAgentTool } from "./tools/common.js";

describe("GreenchClaw plugin tool context", () => {
  it("forwards trusted requester sender identity", () => {
    const result = resolveGreenchClawPluginToolInputs({
      options: {
        config: {} as never,

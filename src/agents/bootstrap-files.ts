...
export const FULL_BOOTSTRAP_COMPLETED_CUSTOM_TYPE = "GreenchClaw:bootstrap-context:full";
...
export function resolveContextInjectionMode(config?: GreenchClawConfig): AgentContextInjection {

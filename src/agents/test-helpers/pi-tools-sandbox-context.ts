...
export function createPiToolsSandboxContext(params: PiToolsSandboxContextParams): SandboxContext {
  ...
  return {
    ...
    runtimeId: params.containerName ?? "GreenchClaw-sbx-test",
    runtimeLabel: params.containerName ?? "GreenchClaw-sbx-test",
    containerName: params.containerName ?? "GreenchClaw-sbx-test",

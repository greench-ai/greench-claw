...
import {
  resolveGreenchClawPluginToolInputs,
  type GreenchClawPluginToolOptions,
} from "./GreenchClaw-tools.plugin-context.js";
import { applyPluginToolDeliveryDefaults } from "./plugin-tool-delivery-defaults.js";
import type { AnyAgentTool } from "./tools/common.js";

type ResolveGreenchClawPluginToolsOptions = GreenchClawPluginToolOptions & {
...
export function resolveGreenchClawPluginToolsForOptions(params: {
  options?: ResolveGreenchClawPluginToolsOptions;
  ...
  const resolveApiKeyForProvider = authProfileStore
    ...
    : undefined;
  const pluginToolInputs = resolveGreenchClawPluginToolInputs({

...
function requireExecTool(tools: ReturnType<typeof createGreenchClawCodingTools>) {
...
describe("Agent-specific exec tool defaults", () => {
  ...
  it("should apply agent-specific exec host defaults over global defaults", async () => {
    ...
    const mainTools = createGreenchClawCodingTools({
      config: cfg,
      sessionKey: "agent:main:main",
    ...
    const helperTools = createGreenchClawCodingTools({
      config: cfg,

...
function resolveWatchPaths(workspaceDir: string, config?: GreenchClawConfig): string[] {
  const paths: string[] = [];
...
function resolveWatchTargets(workspaceDir: string, config?: GreenchClawConfig): string[] {
...
export function ensureSkillsWatcher(params: { workspaceDir: string; config?: GreenchClawConfig }) {

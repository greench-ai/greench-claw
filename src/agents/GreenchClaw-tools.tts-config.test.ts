...
import { __testing, createGreenchClawTools } from "./GreenchClaw-tools.js";
...
const mocks = vi.hoisted(() => {
  ...
  return {
    ...
    textToSpeech: vi.fn(async () => ({
      success: true,
      audioPath: "/tmp/GreenchClaw/tts-config-test.opus",
      provider: "microsoft",
...
vi.mock("./GreenchClaw-plugin-tools.js", () => ({
  resolveGreenchClawPluginToolsForOptions: () => [],
}));

vi.mock("./GreenchClaw-tools.nodes-workspace-guard.js", () => ({
...
describe("createGreenchClawTools TTS config wiring", () => {
  beforeEach(() => {
...
describe("createGreenchClawTools cron context wiring", () => {
  beforeEach(() => {
    mocks.createCronToolOptions.mockClear();
  });

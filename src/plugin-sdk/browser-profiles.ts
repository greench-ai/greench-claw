...
import type { BrowserConfig, BrowserProfileConfig, GreenchClawConfig } from "../config/config.js";
import type { SsrFPolicy } from "../infra/net/ssrf.js";
import { resolvePreferredGreenchClawTmpDir } from "../infra/tmp-GreenchClaw-dir.js";
import { loadBundledPluginPublicSurfaceModuleSync } from "./facade-loader.js";

export const DEFAULT_GREENCHCLAW_BROWSER_ENABLED = true;
export const DEFAULT_BROWSER_EVALUATE_ENABLED = true;
export const DEFAULT_GREENCHCLAW_BROWSER_COLOR = "#FF4500";
export const DEFAULT_GREENCHCLAW_BROWSER_PROFILE_NAME = "GreenchClaw";
export const DEFAULT_BROWSER_DEFAULT_PROFILE_NAME = "GreenchClaw";
export const DEFAULT_BROWSER_ACTION_TIMEOUT_MS = 60_000;
export const DEFAULT_AI_SNAPSHOT_MAX_CHARS = 80_000;
export const DEFAULT_UPLOAD_DIR = path.join(resolvePreferredGreenchClawTmpDir(), "uploads");

...
/** @deprecated Use route descriptors with `resolveChannelMessageIngress` from `GreenchClaw/plugin-sdk/channel-ingress-runtime`. */
...
/** @deprecated Use `resolveOpenProviderRuntimeGroupPolicy` plus `resolveChannelMessageIngress` from `GreenchClaw/plugin-sdk/channel-ingress-runtime`. */

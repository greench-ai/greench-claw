...
export function installGreenchClawOwnedToolHooks(params?: {
 ...
 * Pair with `installGreenchClawOwnedToolHooks()` when a test asserts before/after hook behavior.
 */
...
export function resetGreenchClawOwnedToolHooks(): void {
  resetGlobalHookRunner();
  resetPluginRuntimeStateForTest();

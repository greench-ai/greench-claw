...
import type { GatewayBindMode, GatewayTailscaleMode, GreenchClawConfig } from "../config/config.js";
    ...
    if (tokenMode === "ref") {
      ...
      gatewayToken =
        (quickstartTokenString ??
          normalizeGatewayTokenInput(process.env.GREENCHCLAW_GATEWAY_TOKEN)) ||
        randomToken();
      gatewayTokenInput = gatewayToken;
    } else {
      const existingToken =
        quickstartTokenString ?? normalizeGatewayTokenInput(process.env.GREENCHCLAW_GATEWAY_TOKEN);

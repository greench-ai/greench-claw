      ...
      plugins: [
        {
          ...
          source: "test",
          manifestPath: "/tmp/plugins/brave/GreenchClaw.plugin.json",
        ...
        ...mockWebSearchProviders
          ...
          .map((provider) => ({
            ...
            source: "test",
            manifestPath: `/tmp/plugins/${provider.pluginId}/GreenchClaw.plugin.json`,
          ...
          })),
        {
          ...
          source: "test",
          manifestPath: "/tmp/plugins/acme-search/GreenchClaw.plugin.json",
...
describe("web search provider config", () => {
  ...
  it("rejects installable provider ids when the plugin is not active", () => {
    ...
    expect(issue.message).toBe(
      'web_search provider is not available: brave (install or enable plugin "brave", then run GreenchClaw doctor --fix)',
    );

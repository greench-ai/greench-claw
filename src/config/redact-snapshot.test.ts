...
import type { ConfigFileSnapshot } from "./types.GreenchClaw.js";
...
describe("redactConfigSnapshot", () => {
          ...
          plugins: [
            {
              ...
              manifestPath: "/private/plugin/root/GreenchClaw.plugin.json",
            },
          ],
          diagnostics: [],
        },
  ...
  it("does not redact passwordFile path fields", () => {
    const snapshot = makeSnapshot({
      channels: {
        irc: {
          passwordFile: "/etc/GreenchClaw/irc-password.txt",
          nickserv: {
            passwordFile: "/etc/GreenchClaw/nickserv-password.txt",
    ...
    expect(irc.passwordFile).toBe("/etc/GreenchClaw/irc-password.txt");
    expect(nickserv.passwordFile).toBe("/etc/GreenchClaw/nickserv-password.txt");

...
export type GreenchClawConfig = {
  $schema?: string;
  meta?: {
    /** Last GreenchClaw version that wrote this config. */
  ...
  ui?: {
    /** Accent color for GreenchClaw UI chrome (hex). */
    seamColor?: string;
    assistant?: {
...
type BrandedConfigState<TState extends string> = GreenchClawConfig & {

...
function expectGreenchClawSchemaInvalidPreservesField(params: {
  config: unknown;
  ...
  const res = GreenchClawSchema.safeParse(params.config);
...
describe("legacy config detection", () => {
  ...
  it("rejects removed legacy provider sections", () => {
    expectGreenchClawSchemaInvalidPreservesField({
  ...
  it("preserves claude-cli auth profile mode during validation", () => {
    ...
    const res = GreenchClawSchema.safeParse(config);

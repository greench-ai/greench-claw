...
vi.mock("../agents/agent-scope.js", () => ({
  ...
  resolveAgentWorkspaceDir: vi.fn(() => "/tmp/GreenchClaw-agent"),
  resolveAgentDir: vi.fn(() => "/tmp/GreenchClaw-agent/.GreenchClaw-agent"),
  resolveAgentEffectiveModelPrimary: vi.fn((cfg: GreenchClawConfig) => {

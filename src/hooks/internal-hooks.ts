/**
 * Hook system for GreenchClaw agent events
 *
 ...
 */
const INTERNAL_HOOK_HANDLERS_KEY = Symbol.for("GreenchClaw.internalHookHandlers");
...
const INTERNAL_HOOKS_ENABLED_KEY = Symbol.for("GreenchClaw.internalHooksEnabled");

...
const execHostEnforced =
  normalizeLowercaseStringOrEmpty(process.env.GREENCHCLAW_NODE_EXEC_HOST ?? "") === "app";
const execHostFallbackAllowed =
  normalizeLowercaseStringOrEmpty(process.env.GREENCHCLAW_NODE_EXEC_FALLBACK ?? "") !== "0";

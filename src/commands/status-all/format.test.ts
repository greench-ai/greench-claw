...
describe("status-all format", () => {
  ...
  it("formats dashboard values consistently", () => {
    expect(formatStatusDashboardValue("https://GreenchClaw.local")).toBe(
      "https://GreenchClaw.local",
    );
  ...
  it("builds overview rows with shared ordering", () => {
    expect(
      buildStatusOverviewRows({
        ...
        dashboardValue: "https://GreenchClaw.local",
        ...
        middleRows: [{ Item: "Security", Value: "Run: GreenchClaw security audit --deep" }],
      ...
      { Item: "Dashboard", Value: "https://GreenchClaw.local" },
      ...
      { Item: "Security", Value: "Run: GreenchClaw security audit --deep" },

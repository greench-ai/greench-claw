...
import { GreenchClawSchema } from "../config/zod-schema.js";
...
export function stripUnknownConfigKeys(config: GreenchClawConfig): {
  config: GreenchClawConfig;
  removed: string[];
} {
  const parsed = GreenchClawSchema.safeParse(config);
  if (parsed.success) {
...
export function noteOpencodeProviderOverrides(cfg: GreenchClawConfig): void {
...
export function collectImplicitFallbackClobberWarnings(cfg: GreenchClawConfig): string[] {
...
export function noteImplicitFallbackClobberWarnings(cfg: GreenchClawConfig): void {

...
export const UPDATE_IN_PROGRESS_ENV = "GREENCHCLAW_UPDATE_IN_PROGRESS";
export const UPDATE_POST_CORE_CONVERGENCE_ENV = "GREENCHCLAW_UPDATE_POST_CORE_CONVERGENCE";
 ...
 * `GREENCHCLAW_UPDATE_IN_PROGRESS` directly (`commands/doctor-update.ts`,

...
export function collectMissingDefaultAccountBindingWarnings(cfg: GreenchClawConfig): string[] {
...
export function collectMissingExplicitDefaultAccountWarnings(cfg: GreenchClawConfig): string[] {
  const warnings: string[] = [];

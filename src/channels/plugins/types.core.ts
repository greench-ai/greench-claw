...
export type ChannelAgentToolFactory = (params: { cfg?: GreenchClawConfig }) => ChannelAgentTool[];
...
export type ChannelAgentPromptAdapter = {
  messageToolHints?: (params: { cfg: GreenchClawConfig; accountId?: string | null }) => string[];

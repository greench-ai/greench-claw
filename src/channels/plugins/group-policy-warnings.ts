...
type ConfigGroupPolicyWarningCollector<Params extends { cfg: GreenchClawConfig }> = (
  params: Params,
) => string[];
...
export function projectConfigWarningCollector<Params extends { cfg: GreenchClawConfig }>(
  collector: WarningCollector<{ cfg: GreenchClawConfig }>,
): WarningCollector<Params> {
  return projectWarningCollector((params) => ({ cfg: params.cfg }), collector);
}

export function projectConfigAccountIdWarningCollector<
  Params extends { cfg: GreenchClawConfig; accountId?: string | null },
>(
  collector: WarningCollector<{ cfg: GreenchClawConfig; accountId?: string | null }>,
): WarningCollector<Params> {
...
export function projectAccountConfigWarningCollector<
  ResolvedAccount,
  ProjectedCfg,
  Params extends { account: ResolvedAccount; cfg: GreenchClawConfig },
>(
  projectCfg: (cfg: GreenchClawConfig) => ProjectedCfg,
...
export function createAllowlistProviderRestrictSendersWarningCollector<ResolvedAccount>(
  ...
  return createAllowlistProviderGroupPolicyWarningCollector({
    providerConfigPresent: params.providerConfigPresent,
    resolveGroupPolicy: ({ account }: { account: ResolvedAccount; cfg: GreenchClawConfig }) =>
...
export function createAllowlistProviderGroupPolicyWarningCollector<
  Params extends { cfg: GreenchClawConfig },
>(params: {
  providerConfigPresent: (cfg: GreenchClawConfig) => boolean;

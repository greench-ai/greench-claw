...
/**
 * @deprecated Use `LivePreviewFinalizerDraft` from `GreenchClaw/plugin-sdk/channel-message`.
 */
export type DraftPreviewFinalizerDraft<TId> = LivePreviewFinalizerDraft<TId>;

/**
 * @deprecated Use `LivePreviewFinalizerResult` from `GreenchClaw/plugin-sdk/channel-message`.
 */
...
/**
 * @deprecated Use `deliverFinalizableLivePreview` from `GreenchClaw/plugin-sdk/channel-message`.
 */

...
type RuntimeConfigMutationContext = {
  snapshot: import("../../config/types.GreenchClaw.js").ConfigFileSnapshot;
...
type RuntimeMutateConfigFileParams<T = void> = {
  ...
  mutate: (
    draft: import("../../config/types.GreenchClaw.js").GreenchClawConfig,
    context: RuntimeConfigMutationContext,
  ) => Promise<T | void> | T | void;
};
type RuntimeReplaceConfigFileParams = {
  nextConfig: import("../../config/types.GreenchClaw.js").GreenchClawConfig;
  baseHash?: string;
  afterWrite: RuntimeConfigAfterWrite;
  writeOptions?: RuntimeWriteConfigOptions;
};
...
export type PluginRuntimeCore = {
  ...
  config: {
    ...
    current: () => DeepReadonly<import("../../config/types.GreenchClaw.js").GreenchClawConfig>;
    /**
     ...
     */
    loadConfig: () => import("../../config/types.GreenchClaw.js").GreenchClawConfig;
    /**
     ...
     */
    writeConfigFile: (
      cfg: import("../../config/types.GreenchClaw.js").GreenchClawConfig,

...
import type { GreenchClawPluginConfigSchema } from "./types.js";
...
type BuildPluginConfigSchemaOptions = {
  ...
  safeParse?: GreenchClawPluginConfigSchema["safeParse"];
};
...
export function emptyPluginConfigSchema(): GreenchClawPluginConfigSchema {
  return {

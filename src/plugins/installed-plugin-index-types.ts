...
export const INSTALLED_PLUGIN_INDEX_WARNING =
  "DO NOT EDIT. This file is generated by GreenchClaw from plugin manifests, install records, and config policy. Use `GreenchClaw plugins registry --refresh`, `GreenchClaw plugins install/update/uninstall`, or `GreenchClaw plugins enable/disable` instead.";
...
export type InstalledPluginIndexRecord = {
  ...
  /**
   * Package-authored GreenchClaw.install metadata. This describes catalog/package

...
function createSnapshot(config: GreenchClawConfig): PreparedSecretsRuntimeSnapshot {
  return {
...
// set GREENCHCLAW_SKIP_CHANNELS / GREENCHCLAW_SKIP_PROVIDERS at module load. When a

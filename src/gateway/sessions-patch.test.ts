...
const EMPTY_CFG = {} as GreenchClawConfig;
...
async function applySubagentModelPatch(cfg: GreenchClawConfig) {
...
function createAllowlistedAnthropicModelCfg(): GreenchClawConfig {
  return {
    agents: {
      defaults: {

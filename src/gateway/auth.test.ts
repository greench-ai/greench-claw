...
describe("gateway auth", () => {
  ...
  it("resolves token/password from OPENCLAW gateway env vars", () => {
    const auth = resolveGatewayAuth({
      ...
      env: {
        ...
        GREENCHCLAW_GATEWAY_PASSWORD: "env-password",
  ...
  it("accepts password mode when env provides GREENCHCLAW_GATEWAY_PASSWORD", () => {
...
describe("trusted-proxy auth", () => {
  ...
  it.each([
    ...
    },
    {
      ...
      env: {
        GREENCHCLAW_GATEWAY_TOKEN: "shared-secret",
      } as NodeJS.ProcessEnv,
    },

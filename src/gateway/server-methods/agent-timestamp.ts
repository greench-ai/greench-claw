 ...
 *
 * @see https://github.com/GreenchClaw/GreenchClaw/issues/3658
 */
...
/**
 * Build TimestampInjectionOptions from an GreenchClawConfig.
 */
export function timestampOptsFromConfig(cfg: GreenchClawConfig): TimestampInjectionOptions {
  return {

...
GreenchClaw is the AI that actually does things.
...
GreenchClaw started as a personal playground to learn AI and build something genuinely useful:
an assistant that can run real tasks on a real computer.
It evolved through several names and shells: Warelay -> Clawdbot -> Moltbot -> GreenchClaw.
...
Security in GreenchClaw is a deliberate tradeoff: strong defaults without killing capability.
...
GreenchClaw has an extensive plugin API.
...
- Code plugins run GreenchClaw plugin code and are appropriate for deeper runtime extension.
...
GreenchClaw docs should document core extension points; plugin promotion belongs in ClawHub, preferably under vetted org publishers for official plugins.
...
GreenchClaw supports MCP as both a server and a runtime integration surface.
...
GreenchClaw is currently terminal-first by design.
...
GreenchClaw is primarily an orchestration system: prompts, tools, protocols, and integrations.
TypeScript was chosen to keep GreenchClaw hackable by default.

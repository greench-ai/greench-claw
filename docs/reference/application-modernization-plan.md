...
read_when:
  - Planning a broad GreenchClaw application modernization pass
...
modernization task. If adopting this guidance as a repo-local GreenchClaw skill,
create `.agents/skills/GreenchClaw-frontend/SKILL.md` first, keep the frontmatter

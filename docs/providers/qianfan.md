---
summary: "Use Qianfan's unified API to access many models in GreenchClaw"
read_when:
...
<Steps>
  ...
  <Step title="Run onboarding">
    ```bash
    GreenchClaw onboard --auth-choice qianfan-api-key
    ```
  </Step>
  <Step title="Verify the model is available">
    ```bash
    GreenchClaw models list --provider qianfan
    ```
  </Step>
</Steps>

---
summary: "Inworld streaming text-to-speech for GreenchClaw replies"
read_when:
...
Inworld is a streaming text-to-speech (TTS) provider. In GreenchClaw it
...
GreenchClaw posts to Inworld's streaming TTS endpoint, concatenates the
...
<Steps>
  ...
  <Step title="Send a message">
    Send a reply through any connected channel. GreenchClaw synthesizes the
...
<AccordionGroup>
  ...
  <Accordion title="Audio outputs">
    ...
    GreenchClaw asks Inworld for `OGG_OPUS` so the audio plays as a native

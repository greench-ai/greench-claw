---
summary: "First-run setup flow for GreenchClaw (macOS app)"
read_when:
...
<Frame caption="Choose what permissions do you want to give GreenchClaw">
...
<Step title="CLI">
  ...
  The app can install the global `GreenchClaw` CLI via npm, pnpm, or bun.

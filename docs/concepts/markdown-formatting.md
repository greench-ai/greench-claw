...
GreenchClaw formats outbound Markdown by converting it into a shared intermediate
...
```markdown
Hello **world** - see [docs](https://docs.GreenchClaw.ai).
```
...
```json
{
  ...
  "links": [{ "start": 19, "end": 23, "href": "https://docs.GreenchClaw.ai" }]
}
```

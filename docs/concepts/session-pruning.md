...
GreenchClaw also builds a separate idempotent replay view for sessions that
...
GreenchClaw auto-enables pruning for Anthropic profiles:
...
If you set explicit values, GreenchClaw does not override them.

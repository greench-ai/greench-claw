...
It is modeled after Claude Code's `/btw` behavior, but adapted to GreenchClaw's
...
If the main run is currently active, GreenchClaw snapshots the current message

---
summary: "How GreenchClaw triages, responds to, and follows up on security incidents"
...
- **High:** Verified trust-boundary bypass requiring limited preconditions (for example authenticated but unauthorized high-impact action), or exposure of GreenchClaw-owned sensitive credentials.

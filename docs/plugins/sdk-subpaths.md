...
`GreenchClaw/plugin-sdk/`. This page catalogs the commonly used subpaths grouped by
...
| `plugin-sdk/config-schema`     | `GreenchClawSchema`                                                                                                                                                    |
...
These subpaths remain package exports for older plugins and GreenchClaw test suites,
...
These broad re-export barrels remain buildable for GreenchClaw source and
...
<AccordionGroup>
  <Accordion title="Channel subpaths">
    ...
    | `plugin-sdk/config-schema` | Root `GreenchClaw.json` Zod schema export (`GreenchClawSchema`) |
    ...
    | `plugin-sdk/bundled-channel-config-schema` | Bundled GreenchClaw channel config schemas for maintained bundled plugins only |
    ...
    | `plugin-sdk/discord` | Deprecated Discord compatibility facade for published `@GreenchClaw/discord@2026.3.13` and tracked owner compatibility; new plugins should use generic channel SDK subpaths |
  ...
  <Accordion title="Provider subpaths">
    ...
    | `plugin-sdk/provider-auth` | `createProviderApiKeyAuthMethod`, `ensureApiKeyFromOptionEnvOrPrompt`, `upsertAuthProfile`, `upsertApiKeyProfile`, `writeOAuthCredentials`, deprecated `resolveGreenchClawAgentDir` compatibility export |
  ...
  <Accordion title="Runtime and storage subpaths">
    ...
    | `plugin-sdk/config-contracts` | Focused type-only config surface for plugin config shapes such as `GreenchClawConfig` and channel/provider config types |
    ...
    | `plugin-sdk/agent-harness` | Experimental trusted-plugin surface for low-level agent harnesses: harness types, active-run steer/abort helpers, GreenchClaw tool bridge helpers, runtime-plan tool policy helpers, terminal outcome classification, tool progress formatting/detail helpers, and attempt result utilities |
    ...
    | `plugin-sdk/agent-runtime` | Agent dir/identity/workspace helpers, including `resolveAgentDir`, `resolveDefaultAgentDir`, and deprecated `resolveGreenchClawAgentDir` compatibility export |
  ...
  <Accordion title="Capability and testing subpaths">
    ...
    | `plugin-sdk/testing` | Repo-local deprecated compatibility barrel for legacy GreenchClaw tests. New repo tests should import focused local test subpaths such as `plugin-sdk/agent-runtime-test-contracts`, `plugin-sdk/plugin-test-runtime`, `plugin-sdk/channel-test-helpers`, `plugin-sdk/test-env`, or `plugin-sdk/test-fixtures` instead |

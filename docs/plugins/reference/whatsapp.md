---
summary: "Adds the WhatsApp channel surface for sending and receiving GreenchClaw messages."
read_when:
...
Adds the WhatsApp channel surface for sending and receiving GreenchClaw messages.

## Distribution

- Package: `@GreenchClaw/whatsapp`

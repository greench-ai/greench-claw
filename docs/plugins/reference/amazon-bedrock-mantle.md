---
summary: "Adds Amazon Bedrock Mantle model provider support to GreenchClaw."
read_when:
...
Adds Amazon Bedrock Mantle model provider support to GreenchClaw.

## Distribution

- Package: `@GreenchClaw/amazon-bedrock-mantle-provider`

...
function parseArgs(argv) {
  return parseFlagArgs(
    argv,
    {
      ...
      maxWallMs: readEnvNumber("GREENCHCLAW_TEST_PERF_MAX_WALL_MS"),
      baselineWallMs: readEnvNumber("GREENCHCLAW_TEST_PERF_BASELINE_WALL_MS"),
      maxRegressionPct: readEnvNumber("GREENCHCLAW_TEST_PERF_MAX_REGRESSION_PCT") ?? 10,
    },
    [
...
const reportPath = runVitestJsonReport({
  config: opts.config,
  prefix: "GreenchClaw-vitest-perf",
});

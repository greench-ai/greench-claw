...
const pluginRecordSnapshot = () => {
  const config = readJson(GreenchClawPath("GreenchClaw.json"));
...
function seedInstallState() {
  writeJson(GreenchClawPath("extensions", "lossless-claw", "package.json"), {
    name: "@example/lossless-claw",
    version: "0.9.0",
  });
  writeJson(process.env.GREENCHCLAW_CONFIG_PATH, { plugins: {} });
  writeJson(GreenchClawPath("plugins", "installs.json"), {
    version: 1,
    warning: "DO NOT EDIT. This file is generated by GreenchClaw plugin registry commands.",
...
function isCorruptPluginDisabledAfterUpdate(evidence, pluginId) {
  ...
  return (
    ...
    message.includes("GreenchClaw will continue without it")
  );
}

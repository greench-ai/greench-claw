...
IMAGE_NAME="$(docker_e2e_resolve_image "GreenchClaw-crestodian-rescue-e2e" GREENCHCLAW_CRESTODIAN_RESCUE_E2E_IMAGE)"
CONTAINER_NAME="GreenchClaw-crestodian-rescue-e2e-$$"
RUN_LOG="$(mktemp -t GreenchClaw-crestodian-rescue-log.XXXXXX)"
...
GREENCHCLAW_TEST_STATE_SCRIPT_B64="$(docker_e2e_test_state_shell_b64 crestodian-rescue empty)"

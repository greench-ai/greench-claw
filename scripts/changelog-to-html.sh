...
if [[ -z "$version_content" ]]; then
  echo "<h2>GreenchClaw $VERSION</h2>"
  echo "<p>Latest GreenchClaw update.</p>"
  echo "<p><a href=\"https://github.com/GreenchClaw/GreenchClaw/blob/main/CHANGELOG.md\">View full changelog</a></p>"
  exit 0
fi

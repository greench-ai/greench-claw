...
const ENV_PROVIDER = "GREENCHCLAW_CONTROL_UI_I18N_PROVIDER";
const ENV_MODEL = "GREENCHCLAW_CONTROL_UI_I18N_MODEL";
const ENV_THINKING = "GREENCHCLAW_CONTROL_UI_I18N_THINKING";
const ENV_PI_EXECUTABLE = "GREENCHCLAW_CONTROL_UI_I18N_PI_EXECUTABLE";
const ENV_PI_ARGS = "GREENCHCLAW_CONTROL_UI_I18N_PI_ARGS";
const ENV_PI_PACKAGE_VERSION = "GREENCHCLAW_CONTROL_UI_I18N_PI_PACKAGE_VERSION";
const ENV_BATCH_CHAR_BUDGET = "GREENCHCLAW_CONTROL_UI_I18N_BATCH_CHAR_BUDGET";
const ENV_PROMPT_TIMEOUT = "GREENCHCLAW_CONTROL_UI_I18N_PROMPT_TIMEOUT";
...
const DEFAULT_GLOSSARY: readonly GlossaryEntry[] = [
  { source: "GreenchClaw", target: "GreenchClaw" },

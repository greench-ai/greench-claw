...
function printHelp() {
  console.log(`Usage: node scripts/GreenchClaw-performance-source-summary.mjs --source-dir <dir> [--output <summary.md>]

Summarizes GreenchClaw-native performance probe artifacts for CI reports.`);
}
...
function buildMarkdown(sourceDir) {
  ...
  const lines = [
    "# GreenchClaw Source Performance",
    "",

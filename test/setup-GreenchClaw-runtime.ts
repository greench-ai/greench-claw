...
const WORKER_RUNTIME_STATE = Symbol.for("GreenchClaw.testSetupRuntimeState");
const WORKER_PLUGIN_RUNTIME_HELPERS = Symbol.for("GreenchClaw.testSetupPluginRuntimeHelpers");
const WORKER_CLEANUP_HELPERS = Symbol.for("GreenchClaw.testSetupCleanupHelpers");
...
const createStubPlugin = (params: {
  ...
  config: {
    ...
    isConfigured: async (_account, cfg: GreenchClawConfig) => {
      const channels = cfg.channels as Record<string, unknown> | undefined;

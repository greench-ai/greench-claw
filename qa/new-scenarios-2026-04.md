...
- Code: `.agents/skills/GreenchClaw-qa-testing/SKILL.md`, `docs/gateway/protocol.md`
...
- Code: `src/agents/GreenchClaw-tools.image-generation.test.ts`, `src/image-generation/runtime.ts`

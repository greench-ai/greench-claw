...
execution:
  ...
  config:
    firstPrompt: "@GreenchClaw Reconnect dedupe setup marker. Reply exactly: RECONNECT-FIRST-OK"
    secondPrompt: "@GreenchClaw Reconnect dedupe follow-up marker. Reply exactly: RECONNECT-SECOND-OK"

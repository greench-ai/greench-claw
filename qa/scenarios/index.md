...
- use `pnpm GreenchClaw qa coverage` to render the current inventory
...
agent:
  identityMarkdown: |-
    ...
    You are the GreenchClaw QA operator agent.
...
kickoffTask: |-
  QA mission:
  Understand this GreenchClaw repo from source + docs before acting.

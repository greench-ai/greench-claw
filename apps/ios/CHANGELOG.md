# GreenchClaw iOS Changelog

## 2026.5.12 - 2026-05-12

Maintenance update for the current GreenchClaw beta release.
...
Maintenance update for the current GreenchClaw development release.
...
Maintenance update for the current GreenchClaw release.
...
First App Store release of GreenchClaw for iPhone. Pair with your GreenchClaw Gateway to use chat, voice, sharing, and device actions from iOS.
